...
//  CardinalKit_Example
//
//  Created by Vishnu Ravi on 8/15/21.
...
final class LaunchViewController: UIViewController {
    ...
    @IBAction func loginExistingUser(_ sender: Any) {
        let taskViewController = ORKTaskViewController(task: LoginExistingTask, taskRun: nil)
        taskViewController.delegate = self
        present(taskViewController, animated: true, completion: nil)
    }
...
extension LaunchViewController: ORKTaskViewControllerDelegate {
